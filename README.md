...
| `CHE_AI_ASSISTANT_TASKS_SUPERVISOR_REPOSITORY_URL`    | `https://github.com/akurinnoy/supervisor-terminal`         | Supervisor repository url for implement task                                                   |
| `CHE_AI_ASSISTANT_TASKS_SUPERVISOR_REPOSITORY_BRANCH` | `main`                                                     | Supervisor repository branch for implement task                                                |
