...
const (
	...
	readClaudeTaskStatusInDevWorkspaceTemplate = "Using MCP server `{{.CheMCPServerName}}`, check Claude agent status in DevWorkspace named `{{.DevWorkspaceName}}`. Return one word of Finished/Running/Lost/Idle"
